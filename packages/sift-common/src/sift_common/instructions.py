...
4b. TOOL INVENTORY — Before deep analysis, call suggest_tools on sift-mcp for each artifact type in the case. Memory dumps: idx_ingest_memory. Suspicious binaries: upload_from_host on REMnux. All text evidence (CSV, TSV, log): idx_ingest_delimited. Do NOT default to OpenSearch queries only — the platform has 97+ tools across 9 backends.
