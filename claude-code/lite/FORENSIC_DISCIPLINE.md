...
1. [Alt 1]: [Why possible]
2. [Alt 2]: [Why possible]
...
Maintain in case directory:

### TIMELINE.md
| Timestamp (UTC) | System | Event | Source | Finding |
|-----------------|--------|-------|--------|---------|

- ALL timestamps: full date, time, UTC
- Update IMMEDIATELY when found
- Sort chronologically
- Reference Finding number

### FINDINGS.md
Per finding: Timestamp, Found Via, Source Artifacts, Extraction Method, Raw Evidence, IOCs, Observations, Interpretation, Confidence

### ACTIONS.md
Timestamped log of investigative actions. Log IMMEDIATELY after each action.
