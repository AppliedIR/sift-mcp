...
class TestProcessExpectations:
    ...
    def test_system_process_has_no_parent(self, process_expectations):
        ...
        system = next((p for p in process_expectations if p['process_name'] == 'system'), None)
    ...
    def test_smss_parent_is_system(self, process_expectations):
        ...
        smss = next((p for p in process_expectations if p['process_name'] == 'smss.exe'), None)
    ...
    def test_svchost_parent_is_services(self, process_expectations):
        ...
        svchost = next((p for p in process_expectations if p['process_name'] == 'svchost.exe'), None)
    ...
    def test_lsass_parent_is_wininit(self, process_expectations):
        ...
        lsass = next((p for p in process_expectations if p['process_name'] == 'lsass.exe'), None)
    ...
    def test_cmd_user_type(self, process_expectations):
        ...
        """
        cmd = next((p for p in process_expectations if p['process_name'] == 'cmd.exe'), None)
    ...
    def test_powershell_user_type(self, process_expectations):
        ...
        """
        ps = next((p for p in process_expectations if p['process_name'] == 'powershell.exe'), None)
    ...
    def test_csrss_is_system_process(self, process_expectations):
        ...
        csrss = next((p for p in process_expectations if p['process_name'] == 'csrss.exe'), None)
    ...
    def test_explorer_parent_exits(self, process_expectations):
        ...
        explorer = next((p for p in process_expectations if p['process_name'] == 'explorer.exe'), None)
...
class TestSuspiciousParents:
    ...
    def test_pwsh_has_suspicious_parents(self, process_expectations):
        ...
        pwsh = next((p for p in process_expectations if p['process_name'] == 'pwsh.exe'), None)
    ...
    def test_all_shells_have_same_suspicious_parents(self, process_expectations):
        ...
        parents_sets = []
        for shell in shells:
            proc = next((p for p in process_expectations if p['process_name'] == shell), None)
    ...
    def test_net1_whitelist_approach(self, process_expectations):
        ...
        """
        net1 = next((p for p in process_expectations if p['process_name'] == 'net1.exe'), None)
